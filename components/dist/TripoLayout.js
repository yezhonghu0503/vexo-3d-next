...
var WorkbenchHeader_1 = require("@/components/WorkbenchHeader");
var TripoLayout = function (_a) {
    ...
    var _f = react_1.useState("image"), activeTab = _f[0], setActiveTab = _f[1];
    var _g = react_1.useState({
        ...
        pose: "无",
        multiView: false
    }), imageForm = _g[0], setImageForm = _g[1];
    var _h = react_1.useState({
        ...
        imageEnhance: true,
        multiView: false
    }), modalForm = _h[0], setModalForm = _h[1];
    var _j = react_1.useState({
        search: "",
        selectAnim: ""
    }), actionForm = _j[0], setActionForm = _j[1];
    var _k = react_1.useState(false), modelDropdownOpen = _k[0], setModelDropdownOpen = _k[1];
    // 完整模型列表（和截图完全一致）
    var modelList = [
        {
            value: "gpt_image_2",
    ...
    var _l = react_1.useState(false), styleShow = _l[0], setStyleShow = _l[1]; // 左侧拖拽（改宽度，用 clientX）
    ...
    return (react_1["default"].createElement("div", { className: TripoLayout_module_css_1["default"].layoutWrapper },
        react_1["default"].createElement(WorkbenchHeader_1["default"], null),
