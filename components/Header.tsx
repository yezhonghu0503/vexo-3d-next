      ...
      <div className={styles.container}>
        ...
        <nav className={styles.nav}>
          <Link href="/workbench">
            ...
            >
              <Layers className={`${styles.navIcon} ${isWorkbench ? styles.navIconActive : styles.navIconInactive}`} />
              <span className={isWorkbench ? styles.navTextGradient : styles.navText}>Workbench</span>
