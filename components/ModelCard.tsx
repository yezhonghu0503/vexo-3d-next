    ...
    <div data-cmp="ModelCard" className={styles.card}>
      ...
      <div className={styles.imageContainer}>
        ...
        <div className={styles.badges}>
          <Badge variant="secondary" className={`${styles.badge} ${styles.badgeType}`}>
            {type === 'cartoon' ? 'Cartoon' : type === 'realistic' ? 'Realistic' : 'Low Poly'}
          </Badge>
          <Badge variant="secondary" className={`${styles.badge} ${styles.badgeResolution}`}>
          ...
          <div className={styles.overlayActions}>
             {isWorkbench ? (
               <div className={styles.workbenchActions}>
                 ...
                 <Button size="icon" className={`${styles.overlayButton} ${styles.overlayButtonPurple}`}>
        ...
        {isWorkbench && (
            <div className={styles.footer}>
                ...
                <div className={styles.footerActions}>
                    <Button variant="ghost" size="icon" className={styles.footerButton}>
